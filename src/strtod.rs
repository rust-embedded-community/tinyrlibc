//! Rust implementation of C library function `strtod`
//!
//! Original code from the `c-ward` project.
//! Licensed under the MIT license.

use crate::{CChar, CFloat, CDouble, errno::*};
use core::str::FromStr;
use core::{slice, str};

#[no_mangle]
pub unsafe extern "C" fn strtod(nptr: *const CChar, endptr: *mut *mut CChar) -> CDouble {
...
pub unsafe fn make_str<'a>(start: *const u8, nptr: *const u8) -> &'a str {
...
pub unsafe fn set_endptr(endptr: *mut *mut CChar, nptr: *const u8) {
    if !endptr.is_null() {
...
pub fn set_errno_f32(f: f32, any_nonzero: bool) {
...
pub unsafe fn scan_float(mut nptr: *const u8) -> (*const u8, Format) {
